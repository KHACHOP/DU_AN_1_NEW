...
public class TestForm extends TabbedForm {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        MessageAlerts.getInstance().showMessage("Thông báo kiểm tra thất bại ",
                "Oops! We encountered an issue while attempting to save your data. "
                        + "Please try again later or contact support for assistance. Apologies for any inconvenience caused.", 
