...
public class view_nhanVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rdo_nu.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        rdo_nu.setSelected(true);
        rdo_nu.setText("Nữ");

        buttonGroup1.add(rdo_nam);
        rdo_nam.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        rdo_nam.setText("Nam");

        buttonGroup2.add(rdo_dang);
        rdo_dang.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        rdo_dang.setSelected(true);
        rdo_dang.setText("Đang làm");

        buttonGroup2.add(rdo_da);
        rdo_da.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        ...
        btn_taoMoi.setBackground(new java.awt.Color(255, 204, 204));
        ...
        btn_timKiem.setBackground(new java.awt.Color(255, 204, 204));
        ...
        jLabel7.setText("Tên nhân viên cần tìm");
...
//        int idNhanVien = Integer.parseInt(txt_idNhanVien.getText());
        ...
        nv.setId_nhanVien(Integer.parseInt(txt_idNhanVien.getText()));
...
//                    }
    ...
    private void btn_timKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_timKiemActionPerformed
        ...
        if (search.isEmpty()) {
            ...
            if (service.getNhanVien(search).size() <= 0) {
                JOptionPane.showMessageDialog(null, "Không có nhân viên như vậy");
                return;
            }
            fillTable(search);
        }
...
//        txt_email.setText("");
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        if (txt_idNhanVien.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "Chọn nhân viên ở bảng để xóa");
            return;
        }
        service.xoa(Integer.parseInt(txt_idNhanVien.getText()));
...
//        String email = tbl_nhanVien.getValueAt(index, 4).toString();
        String diaChi = tbl_nhanVien.getValueAt(index, 4).toString();
        String id_taiKhoan = tbl_nhanVien.getValueAt(index, 5).toString();
        String trangThai = tbl_nhanVien.getValueAt(index, 6).toString();
